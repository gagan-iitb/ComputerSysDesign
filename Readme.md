...
|1| ![#1589F0](https://via.placeholder.com/15/1589F0/000000?text=+) Dec 27 | Lab: Introduction to AWS: EC2, S3, DynamoDB, ELB, Kinesis | [2](https://aws.amazon.com/getting-started/hands-on)  [3](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_GettingStarted.CreatingConnecting.MySQL.html) [4](https://realpython.com/api-integration-in-python/)|
|2| ![#c5f015](https://via.placeholder.com/15/c5f015/000000?text=+) Jan3 | Key components in building systems (e.g. AWS services); <br/>System Design Principles: Rules of Thumb, Common Pitfalls in Systems Design; Correctness/Consistency; <br/>Key Metrics: Throughput, Latency, Availability, Jitter/Lags| MB Ch 1,2|
|2| ![#1589F0](https://via.placeholder.com/15/1589F0/000000?text=+) Jan 3 | Case Studies: Architecture of Several Large Applications such as Google Maps, AirBnB, Uber,  DropBox |[5](https://github.com/Jeevan-kumar-Raj/Grokking-System-Design) |
|3| ![#c5f015](https://via.placeholder.com/15/c5f015/000000?text=+) Jan10| Operational Laws: Little's Law, response-time law, asymptotic bounds, modification analysis, performance metrics, open systems, closed systems|MB Ch 6,7|
|3| ![#1589F0](https://via.placeholder.com/15/1589F0/000000?text=+) Jan 10| Lab: Simulations: time averages versus ensemble averages, generating random variables for simulation, Inspection Paradox.|MB Ch 4,5|
|3| ![#1589F0](https://via.placeholder.com/15/1589F0/000000?text=+) Jan 10| Case Studies: Architecture of Several Large Applications such as Instagram, Messenger, Twitter, Web Crawler, Ticketing Engine |[5](https://github.com/Jeevan-kumar-Raj/Grokking-System-Design)|
